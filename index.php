...
if (isset($_POST['btn-login'])) {
    ...
    if (empty($email)) {
        $error = true;
        $emailError = "Please enter something in the email address field.";
    ...
    if (empty($pass)) {
        $error = true;
        $passError = "Please enter something in the password field.";
    }
    ...
    if (!$error) {
        ...
        if ($count == 1) {
            ...
            $errMSG = "The credentials are not correct. Please try again!";
        }
    }
}
